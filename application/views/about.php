...
<html lang="en">
    <head>
        ...
        <title>About-Telkom-Center</title>
    </head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <a class="navbar-brand" href="index.html">.ABOUT<span>TELKOM</span>CENTER.</a>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <a class="dropdown-item active" href="#">Products</a>
                            <a class="dropdown-item active" href="#testimonial">Testimonial</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            <div class="logo">
                                <a href="index.html">.ABOUT<span>TELKOM</span>CENTER.</a>
                            </div>
                            <p>Turacos have much planned for the future, working with great clients and continued software development. If you'd like to join our team, then we'd also love to hear from you.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 text-right">
                            <p>Copyright @2019 About-Telkom-Center. All rights reserved</p>
                        </div>
                    </div>
                </div>
            </div>
